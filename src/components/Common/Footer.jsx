...
const Footer = () => {
  return <footer className="border-t py-12">
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-16">
      <div>
      ...
      <div>
        ...
        <p>
          <FiPhoneCall className="inline-block mr-2"/>01954496221</p>
      </div>
    </div>
    {/*  Footer Bottom */}
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
      <p className="text-gray-500 text-sm tracking-tighter text-center">© 2025, Nayem khan. All Rights Reserved.</p>
    </div>
  </footer>
